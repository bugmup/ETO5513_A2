...
dist_plot <- ggplot(data = pivoted_dist, aes(x = factor(`HELP repayment income`, level = income_factor), y = Count, fill = State)) +
  ...
  xlab("Income Group") +
  labs(title = "Distribution of HELP debtor income in Australian States and Territories", 
...
median_plot <- ggplot(median_pivoted2, aes(x=`Financial year`)) + 
  ...
  labs(title = "Median and mean income of HELP debtors in Australia from 2009 to 2021", 
...
Table \@ref(tab:disttab) presents the counts of students with outstanding HELP debt in each income group, incremented by $10,000, in all States and Territories in the 2021 fiscal year. The distribution of debtors is depicted in Figure \@ref(fig:distfig). Across all income groups, NSW, QLD, and VIC have the highest number of debtors, and most earn within $20,000–$29,999.

Table \@ref(tab:mediantab) presents the median and mean (average) income of HELP debtors in Australia from 2009 to 2021 and the trends are illustrated in Figure \@ref(fig:medianfig). The median and average income follow the same positive trend, increasing overall by one income group ($10,000) since 2009. The median typically sits below the average by one income group. In 2021, the median was $40,000–$49,999, while the average was $50,000–$59,999.
